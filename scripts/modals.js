...
$('#obj-three').click(function () {
  ...
  if (obj_three_click > 1) {
    ...
    if (level==1) {
      $('.modal-content p').append('לחצו על הטכנאי כדי לגלות עובדה מעניינת');
    }
    else if (level==2) {
...
$('#obj-two').click(function () {
  ...
  if (obj_two_click > 1) {
    ...
    $('.modal-content p').append('');
    if (level==1) {
      $('.modal-content p').append('לחצו על הרחפן בתמונה כדי לגלות עובדה מעניינת !');
    }
    else if (level==2) {
...
$('#obj-one').click(function () {
  ...
  if (obj_one_click > 1) {
    ...
    .css('width','62%');
    if (level==1) {
      $('.modal-content p').append('לחצו על קבוצת האנשים הכחולים בתמונה כדי לגלות עובדה מעניינת !');
    }
    else if (level==2) {
